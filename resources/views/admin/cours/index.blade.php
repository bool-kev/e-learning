        ...
        <tbody class="table-group-divider">
            @forelse ($chapitre->cours as $cour)
                <tr>
                    ...
                    <td class="float-end">
                        <a href="{{ route('admin.cours.questions', $cour) }}"><i class="bi bi-chat-text btn btn-info"
                           ></i></a>
                        <a href="{{ route('admin.cours.edit', $cour) }}"><i class="bi bi-pencil-square btn btn-warning"
                                data-bs-toggle="modal" data-bs-target="#ModalEdit{{ $cour->id }}"></i></a>
                        <i class="bi bi-trash3-fill btn btn-danger" data-bs-toggle="modal"
                            data-bs-target="#ModalDelete{{ $cour->id }}"></i>
                    </td>

                    <!-- Modal -->
                    <x-delete-modal :model="$cour" route="cours"
                        message="Tous les fichiers associes seront supprimer"></x-delete-modal>
